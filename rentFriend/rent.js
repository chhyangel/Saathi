...
const data = {
    currentUser: {
      image: {
        png: "images/avatars/star.png",
        webp: "images/avatars/starW.webp",
      },
      username: "Star",
    },
    comments: [
      {
        ...
        id: 1,
        content:
          "Ram is really cheerful and made me feel like a local.",
        createdAt: "1 month ago",
        score: 5,
        user: {
          image: {
            png: "./images/avatars/samP.png",
            webp: "./images/avatars/samw.webp",
          },
          username: "Sam",
        },
        replies: [],
      },
      {
        ...
        id: 2,
        content:
          "Ram is the best companion ever to explore the beauty of Pisang Village.",
        createdAt: "2 weeks ago",
        score: 4,
        user: {
          image: {
            png: "./images/avatars/nellaP.png",
            webp: "./images/avatars/nellaW.webp",
          },
          username: "Nella",
        },
        replies: [
          {
            ...
            id: 1,
            content:
              "Thank you so much for your kind words. Your feedback is truly appreciated.",
            createdAt: "1 week ago",
            score: 1,
            replyingTo: "Sam",
            user: {
              image: {
                png: "./images/avatars/ramP.png",
                webp: "./images/avatars/ramW.webp",
              },
              username: "Ram",
            },
          },
  ...
  const spawnReplyInput = (parent, parentId, replyTo = undefined) => {
    ...
    const inputTemplate = document.querySelector(".replyInputTemplate");
